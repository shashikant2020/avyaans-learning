...
```mermaid
timeline
    title Avyaan's Developmental Journey
    2018 - 2020 : Typical Development : Lived in Munich & Frankfurt. No initial concerns.
    2021 : Regression & Surgery : Regression at 36 months (loss of words, eye contact, hand stimming). Father's bypass surgery.
    2022 - 2023 : Move to Ranchi & Diagnosis : Moved to India (Jan 2023) for waitlist-free therapy (ISIRC, Lalan's). Autism diagnosed.
    2024 : Progress & Berlin Reintegration : Improved eating habits. Returned to Germany (Oct 2024). Enrolled at Ringelnatz-Grundschule.
    2025 : Clinical Testing & Return to India : Diagnoses confirmed (Mar/Apr). Left school for Hindi-based therapy in Noida (late 2025).
    2026 : Noida Schooling & Progress : Enrolled at Sanchetana (Feb 2026). Mastered skip-counting, CVC spelling, and car drawing.
```
